...
import ua.nure.cs.neichev.usermanagement.db.ConnectionFactory;
import ua.nure.cs.neichev.usermanagement.db.ConnectionFactoryImpl;
import ua.nure.cs.neichev.usermanagement.db.DatabaseException;
import ua.nure.cs.neichev.usermanagement.db.HsqldbUserDao;
...
public class HsqldbUserDaoTest extends DatabaseTestCase {
	...
	private static final String LAST_NAME_UPDATE2 = "Roth";
	private static final String FIRST_NAME_UPDATE2 = "Set";
	private static final String FIRST_NAME2 = "Bill";
	private static final String LAST_NAME2 = "Gates";
	private static final long ID = 1000L;

	private static final String LAST_NAME_UPDATE = "Neichev";
	private static final String FIRST_NAME_UPDATE = "Daniil";
